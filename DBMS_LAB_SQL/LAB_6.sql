...
SELECT * FROM STUDENT
WHERE CITY LIKE '%A' AND FirstName LIKE '_____';
...
SELECT * FROM STUDENT 
WHERE FirstName LIKE 'B%A' AND (Website LIKE '%MATH%' OR  WEBSITE LIKE '%SCIENCE') AND CITY LIKE 'B%';
...
SELECT * FROM STUDENT
WHERE Address LIKE '%-%' AND CITY LIKE '[R,B]%' AND Website LIKE '%.COM%';
